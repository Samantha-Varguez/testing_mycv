...
class LinkTestCase(GraphQLTestCase):
    ...
    def setUp(self):
        ...
        id=1, position= "Clerk", location= "Mexico", description= "xd", startDate= "2024-01-01", endDate="2024-02-02" 
        )
        self.link2 = WorkExperience.objects.create(
        id=2, position= "Clerk", location= "Mexico", description= "xd", startDate= "2024-01-01", endDate="2024-02-02" 
    )
    ...
    def test_createWorkExperience_mutation(self):
        ...
        self.assertDictEqual({"createWorkexperience": {'idWorkExperience': 1,'company':'UV', 'position': 'Clerk', 'location': 'Mexico', 'description': 'xd', 'startDate':'2024-01-01', 'endDate':'2024-02-02'}}, content['data'])
